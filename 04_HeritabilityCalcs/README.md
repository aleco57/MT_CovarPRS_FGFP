...
* 04.3 Contains the scripts for calculating Genetic correlation between the MT and covariate of interest

* The actual analyses runs from 04.3 to then 04.2 but have not updated the numbering system
