...
#First check if script has changed from makepipe
make_with_source(
  source = "../02_CompileData/02.2_findheritableMTs.R", 
  targets = file.path(data.path, "data_out/h2bugs_02.2.RData"), 
  dependencies = file.path(data.path, "Hughes_mtGWAS.xlsx"))
